...
Vue.component("simple_footer_component_1723540920", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-pink-400 via-purple-500 to-blue-600 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8">
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-white hover:text-pink-200 transition-colors duration-300">
                            <img id="footer-logo" src="./images/logo.svg" class="h-9 mr-3 filter brightness-0 invert" alt="Landwind Logo" />
